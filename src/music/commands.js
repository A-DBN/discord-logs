...
client.DisTube.on("playSong", (queue, song) => {
    ...
    const buttonRow1 = new ActionRowBuilder().addComponents([previousButton, stopButton, skipButton]);

    const buttonRow2 = new ActionRowBuilder().addComponents([loopButton, queueButton, loopQueueButton]);
...
export async function lyrics(interaction, client) {
...
export async function play(interaction, client) {
...
export async function pause(interaction, client) {
    try {
...
export async function resume(interaction, client) {
    try {
...
export async function stop(interaction, client) {
    try {
...
export async function skip(interaction, client) {
    try {
...
export async function previous(interaction, client) {
    try {
...
export async function queue(interaction, client) {
...
export async function clear(interaction, client) {
    try {
...
export async function loop(interaction, client) {
    const queue = client.DisTube.getQueue(interaction);
    try {
...
export async function loopqueue(interaction, client) {
    const queue = client.DisTube.getQueue(interaction);
    try {
...
export async function unloop(interaction, client) {
    client.DisTube.setRepeatMode(interaction, 0);
    await interaction.reply({ content: `Unlooping queue` });
}

export async function volume(interaction, client) {
    try {
...
export async function remove(interaction, client) {
...
export async function playrandom(interaction, client) {
...
export async function shuffle(interaction, client) {
