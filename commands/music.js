...
const music = require('../music/commands')

module.exports = {
    data: new SlashCommandBuilder()
            .setName('music')
            .setDescription('Music commands')
            .addSubcommand(subcommand => subcommand.setName('play').setDescription('Play music').addStringOption(option => option.setName('link').setDescription('Link or name of the music/playlist').setRequired(true)))
            ...
            .addSubcommand(subcommand => subcommand.setName('loop').setDescription('Loop queue'))
            .addSubcommand(subcommand => subcommand.setName('unloop').setDescription('Unloop queue'))
            .addSubcommand(subcommand => subcommand.setName('volume').setDescription('Change volume').addIntegerOption(option => option.setName('volume').setDescription('Change volume').setRequired(true)))
            .addSubcommand(subcommand => subcommand.setName('remove').setDescription('Remove music').addIntegerOption(option => option.setName('deleteindex').setDescription('Remove a music from the queue').setRequired(true)))
